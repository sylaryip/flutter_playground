...
import 'match_background/match_container_controller.dart';
import 'match_background/match_title.dart';
...
class MatchContainer extends StatefulWidget {
  const MatchContainer({
    super.key,
    this.offsetHeight = 120.0,
    this.rotateHeight = 500.0,
    this.controller,
                ...
                builder: (context, _) {
                  return Transform.scale(
                    ...
                    child: Container(
                      ...
                      decoration: const BoxDecoration(
                          color: Color(0xFF263073),
                          boxShadow: [
                            BoxShadow(
                                color: Color(0x66FFFFFF), offset: Offset(8, 8))
                          ]),
  ...
  Widget _bottomTitle() {
    return AnimatedBuilder(
        ...
        builder: (context, child) {
          return Container(
            alignment: Tween<Alignment>(
                    begin: Alignment.center, end: const Alignment(-2.8, -.85))
                .chain(CurveTween(curve: const Interval(.62, 1.0)))
                .animate(_controller)
                .value,
            transform: Matrix4.translationValues(30.w, 130.w, 0)..scale(0.75),
            transformAlignment: Alignment.center,
            child: AnimatedBuilder(
